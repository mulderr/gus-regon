module Web.BIR.BIR11.Types.Report.Bir11OsFizycznaDzialalnoscPozostala where
...
data Bir11OsFizycznaDzialalnoscPozostala = Bir11OsFizycznaDzialalnoscPozostala 
  ...
  , fizP_dataWpisuDoRejestruEwidencji :: Maybe Day
  , fizP_numerWRejestrzeEwidencji :: Maybe Text
  , fizP_OrganRejestrowy_Symbol :: Maybe Text
  , fizP_OrganRejestrowy_Nazwa :: Maybe Text
  , fizP_RodzajRejestru_Symbol :: Maybe Text
  , fizP_RodzajRejestru_Nazwa :: Maybe Text
